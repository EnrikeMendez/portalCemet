...
<%--        <uc1:SubirArchivo runat="server" ID="FichaTecnica" Etiqueta="Ficha técnica del equipo"
            VisualizaNombreDeArchivoComoLink="true"
            Extensiones=".exe, .pdf" DescargarNombreFuncion="SubirArchivoDownload_Click" />

        <uc1:SubirArchivo runat="server" ID="DocsAdicionales" Etiqueta="Documentos adicionales"
            VisualizaNombreDeArchivoComoLink="true"
            Extensiones=".jpg" DescargarNombreFuncion="DocsAdicionalesDownload_Click" />
        
        <uc1:SubirArchivo runat="server" ID="Marcado" Etiqueta="Marcado"
            VisualizaNombreDeArchivoComoLink="true"
            Extensiones=".jpg" DescargarNombreFuncion="MarcadoDownload_Click" />
  
        <uc1:SubirArchivo runat="server" ID="Diagrama" Etiqueta="Diagrama"
            VisualizaNombreDeArchivoComoLink="true"
            Extensiones=".jpg" DescargarNombreFuncion="DiagramaDownload_Click" />

        <uc1:SubirArchivo runat="server" ID="InstructivoManual" Etiqueta="Instructivo o manual"
            VisualizaNombreDeArchivoComoLink="true"
