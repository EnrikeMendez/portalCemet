...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" id="FormularioRecoleccion">
        <div class="row">
    ...
    <div runat="server" id="MensajeExito">
        <div class="row" runat="server" id="MsgSolicitudCreada">
            <h3>Programación agendada correctamente</h3>
            <label>Se ha creado correctamente la programación de recolección para las siguientes solicitudes: </label>
            

            <%
                Response.Write("<ul class='form-control'>");
                foreach (var item in SolicitudesProgramadas)
                {
